...
const QString BITCOIN_IPC_PREFIX("cpacoin:");

static QString ipcServerName()
{
    QString name("cpacoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start CpaCoin: click-to-pay handler");
    else
...
{
    // clicking on cpacoin: URLs creates FileOpen events on the Mac:
