...
void MainWindow::setMainWindowTitle() {
  setWindowTitle(QString(tr("CpaCoin Wallet %1")).arg(Settings::instance().getVersion()));
}
...
#else
  m_langPath = "/opt/cpacoin/languages";
#endif
  QDir dir(m_langPath);
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at https://cryptopay.org.za"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("CpaCoin Wallet %1")).arg(Settings::instance().getVersion());
